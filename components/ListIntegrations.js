...
const ListIntegrations = ({ navigation }) => {
    ...
    return TAB_INTEGRATIONS.map((integration) => {
      return (
        <View
          ...
          style={styleListIntegrations.integrationsItems}
        >
            ...
            <View style={styleListIntegrations.containerColumn}>
              <View style={styleListIntegrations.imageItems}>
                <Image
                  ...
                  style={styleListIntegrations.integrationsImages}
                />
              </View>
              <View style={styleListIntegrations.textItems}>
                <Text style={styleListIntegrations.textIntegrations}>
                  {integration.type}
                </Text>
              </View>
            </View>
  ...
  return (
    <View>
      ...
      <View style={styleListIntegrations.containerRow}>
        {listIntegrations()}
      </View>
    </View>
  );
